		...
		>
			{chips.map((ch) => (
				...
				>
					...
					/>
					<svg width="12" height="12" viewBox="0 0 14 14" fill="none" style={{ color: "var(--brass-text)", flex: "none" }} aria-hidden>
					...
					<span
						...
						style={{ fontSize: 14, lineHeight: 1, color: "var(--ink-3)", cursor: "pointer", flex: "none" }}
					>
						×
					</span>
				</div>
			...
			{fcThread && (
				...
				>
					...
					>
						...
						>
							<svg width="11" height="11" viewBox="0 0 12 12" aria-hidden>
								<line x1="2.5" y1="9.5" x2="9.5" y2="9.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
							</svg>
						</span>
						<span
					...
					<div style={{ flex: "none", display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap", padding: "8px 13px 0" }}>
						<svg width="10" height="10" viewBox="0 0 12 12" fill="none" style={{ color: "var(--ink-3)", flex: "none" }} aria-hidden>
						...
						<span style={{ fontFamily: "var(--w-font-body)", fontSize: 11, color: "var(--ink-3)" }}>
							Odpovídáš jako <span style={{ fontWeight: 600, color: "var(--ink-2)" }}>Adam Košír</span> za
						</span>
						<span
							style={{
						...
						<span style={{ marginLeft: "auto", fontFamily: "var(--w-font-mono)", fontSize: 9, color: "var(--ink-3)" }}>
					...
					<div style={{ flex: "none", display: "flex", gap: 7, alignItems: "center", padding: "9px 13px 12px" }}>
						<span
							onClick={() => {
								m.checkSend(fcThread, false);
								m.setFloat(null);
						...
						<span
							...
							style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 29, height: 29, padding: 0 }}
						>
