...
export const ICONS = {
  ...
  priorita: '<line x1="6" y1="3" x2="6" y2="21"/><path d="M6 4.5 H18 L15 8 L18 11.5 H6 Z"/>',
  prirazeni:
  ...
  deadline: '<circle cx="12" cy="12.4" r="7.6"/><path d="M12 7.6 V12.4 L15.4 14.2"/>',
  opakovani:
  ...
  pridat: '<line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/>',
  ...
  vice:
    '<circle cx="6" cy="12" r="1.7" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.7" fill="currentColor" stroke="none"/><circle cx="18" cy="12" r="1.7" fill="currentColor" stroke="none"/>',
  zavrit:
    '<line x1="6.5" y1="6.5" x2="17.5" y2="17.5"/><line x1="17.5" y1="6.5" x2="6.5" y2="17.5"/>',
  hledat: '<circle cx="10.5" cy="10.5" r="6"/><line x1="15" y1="15" x2="20" y2="20"/>',
  schranka:
  ...
  dnes:
    '<line x1="3.6" y1="18.4" x2="20.4" y2="18.4"/><path d="M7.6 18.4 A4.4 4.4 0 0 1 16.4 18.4"/><line x1="12" y1="6" x2="12" y2="8"/><line x1="5.6" y1="9.2" x2="6.9" y2="10.2"/><line x1="18.4" y1="9.2" x2="17.1" y2="10.2"/>',
  nadchazejici:
  ...
  tym:
    '<circle cx="9" cy="9.2" r="3"/><path d="M3.6 19 C3.6 15.6 6 13.7 9 13.7 C12 13.7 14.4 15.6 14.4 19"/><circle cx="16.6" cy="9.6" r="2.4"/><path d="M15.2 13.9 C18.6 13.9 20.4 15.9 20.4 19"/>',
  cile:
    '<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1.4" fill="#c68a3e" stroke="none"/>',
  reporty:
