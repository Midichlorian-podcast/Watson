...
export const workspaceRoleEnum = pgEnum("workspace_role", tuple(WORKSPACE_ROLES));
...
export const aiSuggestionStatusEnum = pgEnum("ai_suggestion_status", tuple(AI_SUGGESTION_STATUS));
