...
export const calendarLinks = pgTable(
  ...
  (t) => [uniqueIndex("calendar_links_task_provider_uq").on(t.taskId, t.provider)],
);
...
export const auditEvents = pgTable(
  ...
  (t) => [index("audit_workspace_idx").on(t.workspaceId), index("audit_entity_idx").on(t.entity, t.entityId)],
);
...
export const aiPolicies = pgTable(
  ...
  (t) => [uniqueIndex("ai_policies_workspace_capability_uq").on(t.workspaceId, t.capability)],
);
